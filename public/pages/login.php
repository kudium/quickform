    ...
    <div class="max-w-md w-full space-y-8 bg-white p-8 rounded-xl shadow-lg">
        <div>
            ...
            <p class="mt-2 text-center text-sm text-gray-600">
                Or <a href="auth/register" class="font-medium text-indigo-600 hover:text-indigo-500 transition duration-150 ease-in-out">create a new account</a>
            </p>
        </div>

        <?php if ($message): ?>
            <div class="rounded-md <?php echo (isset($_GET['registered']) || isset($_GET['reset'])) ? 'bg-green-50' : 'bg-red-50'; ?> p-4">
                <div class="flex">
                    <div class="flex-shrink-0">
                        <?php if (isset($_GET['registered']) || isset($_GET['reset'])): ?>
                    ...
                    <div class="ml-3">
                        <p class="text-sm font-medium <?php echo (isset($_GET['registered']) || isset($_GET['reset'])) ? 'text-green-800' : 'text-red-800'; ?>">
        ...
        <form class="mt-8 space-y-6" method="POST">
            ...
            <div class="flex items-center justify-between">
                <div class="text-sm">
                    <a href="auth/forgot-password" class="font-medium text-indigo-600 hover:text-indigo-500 transition duration-150 ease-in-out">
